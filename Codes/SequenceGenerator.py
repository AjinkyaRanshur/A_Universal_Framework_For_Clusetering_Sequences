...
transition_matrix_1 = [
    [1.0, 0.0, 0.0, 0.0],  # A -> [A, T, G, C]
    [0.0, 1.0, 0.0, 0.0],  # T -> [A, T, G, C]
    [0.0, 0.0, 1.0, 0.0],  # G -> [A, T, G, C]
    [0.0, 0.0, 0.0, 1.0],  # C -> [A, T, G, C]
]

transition_matrix_2 = [
    [0.0, 1, 0.0, 0.0],  # A -> [A, T, G, C]
    [1, 0.0, 0.0, 0.0],  # T -> [A, T, G, C]
    [0.0, 0.0, 0.0, 1],  # G -> [A, T, G, C]
    [0.0, 0.0, 1, 0.0],  # C -> [A, T, G, C]
]
...
with open("D:\Repo\A_Universal_Framework_For_Clusetering_Sequences\Datasets\Ajinkya_Synthetic_Dataset\AJR_Dataset_Sequences_100k.fa",'w') as f:
    # genomic_sequences = []
